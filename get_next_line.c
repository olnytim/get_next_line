...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/21 21:11:44 by tgalyaut          #+#    #+#             */
/*   Updated: 2023/03/28 20:39:06 by tgalyaut         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*ft_save(char *save)
{
	...
	string = (char *)malloc(ft_strlen(save) - integer + 1);
	if (!string)
		return (NULL);
	++integer;
	temp = string;
